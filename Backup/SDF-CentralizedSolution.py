...
base_results_dir = '/home/akhil/SliceCapacityForecasting/Results/Milano-Averaged/Centralized/'
client_directory_path = '/home/akhil/SliceCapacityForecasting/Datasets/SDF_Datasets/MI-2013-Averaged/ClientData'
...
for obsv_win_len, pred_win_len in zip(OBSERVATION_WINDOW_RANGE, PREDICTION_WINDOW_RANGE):
	...
	for configuration in config_list:
		...
		for model in models:
			...
			global_test_dataset = (client_datasets[0])[1]
			for client_id in client_ids:
				############################# ClientWise - Test Procedure ##############################
				client_data = client_datasets[client_id]
