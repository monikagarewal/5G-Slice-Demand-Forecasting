...
base_model_dir = '../Models/Milano-Averaged/Local/'
base_results_dir = '../Results/Milano-Averaged/Local/'
	...
	for configuration in config_list:
		...
		for client_id in client_ids:
			...
			for model in models:
				...
				model_dir = base_model_dir + combo_dir + 'client-' + str(client_id)+  '/' + algorithm + model + '/'
